...
export const HERO_CONTENT = `I am a passionate full stack developer with a knack
 for crafting robust and scalable web applications. 
...
export const ABOUT_TEXT = `I am a dedicated and versatile full stack developer with a passion for creating
 efficient and user-friendly web applications. With one years of professional experience,
  I have worked with a variety of technologies, including React, Next.js, Node.js, and MongoDB
  ...
  Alongside developing software, I hold a degree in Electrical and Computer Engineering, I enjoy staying active, exploring new technologies, and contributing to open-source projects.`;

export const EXPERIENCES = [
  {
    year: "2023 - Present",
    role: "jounior Full Stack Developer",
    company: "sidama science and technology",
    description: `Led a team in developing and maintaining web applications 
     JavaScript, React.js, and Node.js. Implemented RESTful APIs and integrated with MongoDB databases.
...
export const CONTACT = {
  address: "trufat, hawassa, Ethiopia ",
  phoneNo: "+251 941865778 ",
  email: "amanuelbekele771@gmail.com",
};
